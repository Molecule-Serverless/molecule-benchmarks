...
const EnterHomeHandler = {
    ...
    handle(handlerInput) {
        ...
        // here we rm the filter for password, because the parameter is default, HCloud does not support default param.
        let enterRequest;
        // if (password !== smarthome_password) {
        //     enterRes = 'wrong-token';
        // } else {
        //     enterRes = enterHome(password);
        // }
        enterRequest = enterHome(password);
        console.log("enterRequest: %o", enterRequest)
        return enterRequest;
    },
};
