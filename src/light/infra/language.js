 ...
 *
 * This file is a trim down of the original file (lambda/custom/index.js)
 * from https://github.com/alexa/skill-sample-nodejs-fact.
 * This file only keeps the language handling part of the original file
 * to provide as a common utility for different skills.
 */
...
const LocalizationInterceptor = {
    process(handlerInput) {
        ...
        console.log("in i18n envelop : %o", handlerInput.requestEnvelope)
        console.log("in i18n request : %o", handlerInput.requestEnvelope.request)
...
exports.LocalizationInterceptor = LocalizationInterceptor
