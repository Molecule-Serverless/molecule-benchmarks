...
function run_test(){
	...
	./app_template_build_prebuilt.sh ddnirvana/molecule-ae-python-base-image:latest-arm #> /dev/null 2>&1
	./app_base_build_prebuilt.sh ddnirvana/molecule-ae-app-$2-base:latest-arm #> /dev/null 2>&1
	./app_endpoint_build_prebuilt.sh ddnirvana/molecule-ae-app-$2-ep:latest-arm #> /dev/null 2>&1
	./kill_all.sh
...
run_test_friendly LinPack linpack
run_test_friendly Chameleon chameleon
run_test_friendly Matmul matmul
run_test_friendly PyAES pyaes
run_test_friendly DD dd
run_test_friendly Gzip-comprssion gzip-compression
run_test_long_friendly Video-Processing video-processing
